...
@switch($name)
    ...
    @case('external-link')
        <svg {{ $attributes->merge(['class' => $class]) }} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v9.75A2.25 2.25 0 005.25 20.25h9.75A2.25 2.25 0 0017.25 18V9.75m-3.75 0V5.25A2.25 2.25 0 0115.75 3h4.5A2.25 2.25 0 0121 5.25v4.5A2.25 2.25 0 0118.75 12h-9"/>
        </svg>
        @break
    @case('phone')
        <svg {{ $attributes->merge(['class' => $class]) }} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
